...
class CategoryRepoImplementation implements CategoryRepo {
  ...
  @override
  Future<Either<Failure, Category>> getCategoriesDetails() async {
    try {
      final response = await _categorySource.categorySourceDetails();
      final categoryDetails = Category.fromJson(response);
